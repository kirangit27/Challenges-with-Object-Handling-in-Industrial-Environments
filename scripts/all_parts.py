...
class Render:
    def __init__(self):
        ...
        self.obj_names = ['battery_blue', 'battery_green', 'battery_orange', 'battery_purple', 'battery_red', 'pump_blue', 'pump_green', 'pump_orange', 'pump_purple']#, 'pump_red']
        self.objects = [bpy.data.objects[obj_name] for obj_name in self.obj_names]#self.create_objects() # Create list of bpy.data.objects from bpy.data.objects[1] to bpy.data.objects[N]
        
        self.objects[0].rotation_euler = (0,0,0)
        self.objects[1].rotation_euler = (0,0,0)
        self.objects[2].rotation_euler = (0,0,0)
        self.objects[3].rotation_euler = (0,0,0)
        self.objects[4].rotation_euler = (0,0,0)
        self.objects[5].rotation_euler = (0,0,0)
        self.objects[6].rotation_euler = (0,0,0)
        self.objects[7].rotation_euler = (0,0,0)
        self.objects[8].rotation_euler = (0,0,0)
        ...
        self.images_filepath = '/home/ksp/Desktop/808_blender/Data/images'
        self.labels_filepath = '/home/ksp/Desktop/808_blender/Data/labels'
    ...
    def main_rendering_loop(self, rot_step):
        ...
        if accept_render == 'Y': # If the user inputs 'Y' then procede with the data generation
            ...
            for d in range(dmin, dmax + 1, 2): # Loop to vary the height of the camera
                ...
                self.objects[4].hide_viewport = False
                self.objects[4].hide_render = False
...
#                        self.objects[0].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[1].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[2].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[3].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[4].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[5].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[6].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[7].rotation_euler = (0,0,random.uniform(-90, 90))
#                        self.objects[8].rotation_euler = (0,0,random.uniform(-90, 90))
...
#                txt_coordinates = str(classe) + ' ' + str(cx) + ' ' + str(cy) + ' ' + str(width) + ' ' + str(height) + '\n'
#            elif (d_height==4.4 and width*height >= 0.005 and height>0.04 and width>0.04):
#                txt_coordinates = str(classe) + ' ' + str(cx) + ' ' + str(cy) + ' ' + str(width) + ' ' + str(height) + '\n'    
            txt_coordinates = str(classe) + ' ' + str(cx) + ' ' + str(cy) + ' ' + str(width) + ' ' + str(height) + '\n'
